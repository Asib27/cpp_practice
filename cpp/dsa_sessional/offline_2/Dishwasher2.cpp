...
int main(){
    ...
    CleandDish stack_array[n*x];

    MyStack<CleandDish> *dirty = new ArrayStack<CleandDish>(stack_array, n*x, 1);//new ArrayStack<Dish>();
    MyStack<CleandDish> *clean = new ArrayStack<CleandDish>(stack_array, n*x, -1);//new ArrayStack<CleandDish>();
